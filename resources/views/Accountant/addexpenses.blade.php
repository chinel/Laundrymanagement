...
<div class="wrapper">
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4 class="page-title">Record Expenses</h4>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card-box">
                    ...
                    <form class="form-horizontal" role="form" data-parsley-validate novalidate method="post" action="{{url('/Accountant/recordExpenses')}}">
                        <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Title</label>
                            <div class="col-sm-10">
                                <input type="text" required  class="form-control"
                                       placeholder="Expense title" name="title">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-10">
                                ...
                                <input type="text" id="example-input3-group1" required name="amount" class="form-control" placeholder="0.00">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Receiver</label>
                            <div class="col-sm-10">
                                <input type="text" required  class="form-control" name="receiver"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="mm/dd/yyyy" id="datepicker" required name="exp_date">
