        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="btn-group pull-right m-t-15">
                    <a class="btn btn-custom waves-effect waves-light"  href="{{url('/Admin/addCloth')}}"><span class="m-l-5"><i class="fa fa-plus"></i></span> Add new cloth </a>

                </div>
                <h4 class="page-title">Cloth List</h4>
            </div>
                    ...
                    <table class="table m-0">
                        ...
                        @foreach($clothes as $clothe)
                            <tr>
                                ...
                                <td>{{$clothe->title}}</td>
                                <td>{{$clothe->created_at}}</td>
                                <td>
                                    <a class="btn btn-icon waves-effect waves-light btn-warning m-b-5" title="Edit" href="{{url('/Admin/'.$clothe->id.'/edit')}}"> <i class="fa fa-pencil"></i> </a>
                                </td>
                            </tr>
                        @endforeach
