        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card-box">
                    ...
                    <form class="form-horizontal" role="form" data-parsley-validate novalidate method="post" action="{{url('Admin/editCustomer/'.$customer->id)}}" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                        <div class="form-group">
                            <label  class="col-sm-2 control-label">First Name*</label>
                            <div class="col-sm-10">
                                <input type="text" required  class="form-control" name="fname" value="{{$customer->fname}}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" required  class="form-control" name="lname" value="{{$customer->lname}}"
                                       placeholder="First Name">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input  type="text" placeholder="Password" required parsley-type="number" name="contact" value="{{$customer->contact}}"
                                        class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea required class="form-control" name="address">{{$customer->address}}</textarea>
                            </div>
                        </div>


                        <div class="form-group">
                            <label  class="col-sm-2 control-label">Customer's old Photo*</label>
                            <div class="col-sm-10">
                                <img src="{{asset('uploads/'.$customer->photo)}}" width="150" height="150"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label  class="col-sm-2 control-label">Customer's new Photo*</label>
                            <div class="col-sm-10">
