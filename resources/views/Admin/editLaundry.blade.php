    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <h4 class="page-title">Edit {{$laundry->name}} laundry service</h4>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card-box">
                    ...
                    <form action="{{url('/Admin/editLaundry/'.$laundry->id)}}" data-parsley-validate novalidate method="post">
                        <div class="form-group">
                            <label for="userName">Laundry type*</label>
                            <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                            <input type="text" name="name" parsley-trigger="change" required
                                   placeholder="Enter type of laundry service" class="form-control" id="userName" value="{{$laundry->name}}">
                        </div>
