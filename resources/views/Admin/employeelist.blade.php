        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="btn-group pull-right m-t-15">
                    <a class="btn btn-custom waves-effect waves-light" href="{{url('/Admin/addEmployee')}}"><span class="m-l-5"><i class="fa fa-plus"></i></span> New Employee entry </a>
                    ...
                    <table class="table m-0">
                        ...
                        @foreach($employees as $employee)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-icon waves-effect waves-light btn-warning m-b-5" title="Edit" href="{{url('Admin/'.$employee->id.'/editEmployee')}}"> <i class="fa fa-pencil"></i> </a>
                                </td>
                            </tr>
                            @endforeach
