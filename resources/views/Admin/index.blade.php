        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="card-box">
                    ...
                    <h4 class="header-title m-t-0 m-b-30">Today's Orders</h4>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            @foreach($todayOrders as $todayOrder)
                                <tr>
                                    <td>{{$todayOrder->id}}</td>
                                    <td>{{$todayOrder->fname}} {{$todayOrder->lname}}</td>
                                    <td>{{$todayOrder->created_at}}</td>
                        ...
                        <table class="table">
                            ...
                            @foreach($pendingOrders as $pendingOrder)
                                <tr>
                                    ...
                                    <td>{{$pendingOrder->fname}} {{$pendingOrder->lname}}</td>
                                    <td>{{$pendingOrder->created_at}}</td>
                                    <td>{{$pendingOrder->delivery_date}}</td>
