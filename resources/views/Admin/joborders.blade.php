        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="btn-group pull-right m-t-15">
                    <a class="btn btn-custom waves-effect waves-light" href="{{url('/Admin/addOrder')}}"><span class="m-l-5"><i class="fa fa-plus"></i></span> New Job order </a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="{{url('/Admin/viewOrder/'.$order->customer_id)}}">View</a></li>
                                            <li><a href="{{url('/Admin/assignLaunderer/'.$order->customer_id)}}">Assign Launderer</a></li>
                                            <li><a href="{{url('/Admin/markCompleted/'.$order->customer_id)}}">Mark as completed</a></li>
                                        </ul>
                                    </div>
                                </td>
