        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="btn-group pull-right m-t-15">
                    <a class="btn btn-custom waves-effect waves-light" href="{{url('/Admin/addLaundry')}}"><span class="m-l-5"><i class="fa fa-plus"></i></span> New laundry service </a>

                </div>
                <h4 class="page-title">Laundry Types</h4>
            </div>
        </div>
                    ...
                    <table class="table m-0">
                        ...
                        @foreach($laundries as $laundry)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-icon waves-effect waves-light btn-warning m-b-5" title="Edit" href="{{url('/Admin/'.$laundry->id.'/editLaundry')}}"> <i class="fa fa-pencil"></i> </a>
                                </td>
                            </tr>
                            @endforeach
