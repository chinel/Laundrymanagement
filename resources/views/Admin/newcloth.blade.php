    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <h4 class="page-title">Add new cloth type</h4>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card-box">
                    ...
                    <form action="{{url('/Admin/addCloth')}}" method="post" data-parsley-validate novalidate>
                        <div class="form-group">
                            <label for="userName">Cloth type*</label>
                            <input type="text" name="title" parsley-trigger="change" required
                                   placeholder="Enter type of cloth" class="form-control" id="userName" >
