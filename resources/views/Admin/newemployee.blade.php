        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card-box">
                    ...
                    <form class="form-horizontal" role="form" data-parsley-validate novalidate action="{{url('/Admin/addEmployee')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input  type="text" placeholder="Phone" required parsley-type="number" name="contact"
                                        class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="mm/dd/yyyy" id="datepicker" required name="birthdate">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input  type="password" placeholder="Password"  parsley-type="password" required name="password"
                                        class="form-control">
                            </div>
                        </div>

                        <div class="form-group">
                            <label  class="col-sm-2 control-label">Employee's Photo*</label>
                            <div class="col-sm-10">
