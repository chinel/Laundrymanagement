    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <h4 class="page-title">Add new laundry service</h4>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card-box">
                    ...
                    <form action="{{url('/Admin/addLaundry')}}" data-parsley-validate novalidate method="post">
                        <div class="form-group">
                            <label for="userName">Laundry type*</label>
                            <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                            <input type="text" name="name" parsley-trigger="change" required
                                   placeholder="Enter type of laundry service" class="form-control" id="userName">
                        </div>
