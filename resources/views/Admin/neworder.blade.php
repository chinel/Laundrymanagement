...
<div class="wrapper">
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4 class="page-title">Add new job order</h4>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card-box">
                    ...
                    <form class="form-horizontal" role="form" data-parsley-validate novalidate action="{{url('/Admin/addOrder')}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" required name="cloth_id" id="cloth">
                                    <option value="">Select cloth type</option>
                                    @foreach($clothes as $clothe)
                                        <option value="{{$clothe->id}}">{{$clothe->title}}</option>
                                    @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" required name="laundry_id" id="laundry">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#quantity').blur(function (e) {
            ...
            if (cloth != "" & laundry != "" & customer != "" & quantity > 0) {

                $('#total').val("Calculating total price....");
                $.ajax({
                    url: "/Admin/getTotalPrice/"+cloth+"/"+ laundry,
                    type:'GET',

                    success: function(data) {

                        var price = quantity * parseInt(data[0].price);
