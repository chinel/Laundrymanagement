    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <h4 class="page-title">Add new laundry price</h4>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card-box">
                    ...
                    <form action="{{url('/Admin/addPrice')}}" data-parsley-validate novalidate class="form-horizontal" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-10">
                                ...
                                <input type="text" id="example-input3-group1" name="price" class="form-control" placeholder="0.00" required >
                            </div>
                        </div>
