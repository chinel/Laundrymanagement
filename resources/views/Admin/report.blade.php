        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card-box">
                    ...
                    <form class="form-inline" role="form" data-parsley-validate novalidate action="{{url('/Admin/getReport')}}" method="post">
                   <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        <input type="text" class="form-control datepick" placeholder="mm/dd/yyyy" required name="from">
                        ...
                        <div class="form-group m-r-10">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        <input type="text" class="form-control datepick" placeholder="mm/dd/yyyy" required name="to">
                                        <span class="input-group-addon bg-primary b-0 text-white"><i class="ti-calendar"></i></span>
                                    </div><!-- input-group -->
                                </div>
                            </div>
