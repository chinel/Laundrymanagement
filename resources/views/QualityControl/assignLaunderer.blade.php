...
<div class="wrapper">
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4 class="page-title">Assign Job order to Launderer</h4>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card-box">
                    ...
                    <form class="form-horizontal" role="form" data-parsley-validate novalidate method="post" action="{{url('/QualityControl/recordLaunderer')}}">



                        <div class="form-group">
                            <label class="col-sm-2 control-label">Select Launderer</label>
                            <div class="col-sm-10">
                                <select class="form-control" required name="launderer_id">
                                    <option>Select launderer</option>
                                    @foreach($launderers as $launderer)
                                        <option value="{{$launderer->id}}">{{$launderer->fname}} {{$launderer->lname}}</option>
                                    @endforeach
