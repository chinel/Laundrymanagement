...
<div class="wrapper">
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4 class="page-title">Launderers</h4>
            </div>
        </div>
                ...
                <div class="card-box">
                    ...
                    <table class="table m-0">
                        ...
                        @foreach($launderers as $launderer)
                            <tr>
                                <td>{{$launderer->fname}} {{$launderer->lname}}</td>
                                <td>{{$launderer->contact}}</td>
                                <td>@if($launderer->status == 'inactive') <span class="label label-warning">Inactive</span> @else <span class="label label-success">Active</span> @endif</td>
